...
import { FolderKanban, ListTodo, Users, Plus, ArrowRight, Search } from 'lucide-react';
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">
            {hasData ? 'Dashboard' : `Welcome, ${name}`}
          </h1>
        ...
        <div className="hidden items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm text-gray-400 shadow-sm sm:flex">
          <Search className="h-4 w-4" />
          <span>Search...</span>
          <kbd className="ml-2 rounded border border-gray-200 bg-gray-50 px-1.5 py-0.5 text-xs">
            ⌘K
          </kbd>
        </div>
      </div>
