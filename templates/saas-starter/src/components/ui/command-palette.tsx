...
const NAV_ITEMS: SearchResult[] = [
  { id: 'nav-dashboard', label: 'Dashboard', category: 'navigation', icon: <LayoutDashboard className="h-4 w-4" />, path: '/dashboard' },
  { id: 'nav-projects', label: 'Projects', category: 'navigation', icon: <FolderKanban className="h-4 w-4" />, path: '/dashboard/projects' },
  { id: 'nav-tasks', label: 'Tasks', category: 'navigation', icon: <ListTodo className="h-4 w-4" />, path: '/dashboard/tasks' },
  { id: 'nav-team', label: 'Team', category: 'navigation', icon: <Users className="h-4 w-4" />, path: '/dashboard/team' },
  { id: 'nav-settings', label: 'Settings', category: 'navigation', icon: <Settings className="h-4 w-4" />, path: '/dashboard/settings' },
];
...
export function CommandPalette({ open, onClose, projects, tasks, team }: CommandPaletteProps) {
