...
// ============================================================================
// Re-export Core Thirdweb Types
// ============================================================================

// Note: Thirdweb v5 has a different type structure than v4.
// Most types are inferred from runtime functions rather than exported directly.
// We define Varity-specific types below that are compatible with Thirdweb v5.

// Re-export available core Thirdweb SDK types
export type {
  // Core SDK types
  ThirdwebClient,
  Chain,
...
// ============================================================================
// Varity L3 Chain Configuration Types
// ============================================================================
...
// ============================================================================
// Varity Wallet Configuration Types
// ============================================================================
...
// ============================================================================
// Contract Deployment & Interaction Types
// ============================================================================
...
// ============================================================================
// Sign-In With Ethereum (SIWE) Types
// ============================================================================
...
// ============================================================================
// Event Listening & Filtering Types
// ============================================================================
...
// ============================================================================
// Wrapper Pattern Types (Thirdweb + Ethers Hybrid)
// ============================================================================
...
// ============================================================================
// Thirdweb Client Configuration Types
// ============================================================================
 ...
 */
export function isVarityChain(chain: any): chain is VarityChain {
  return (
    typeof chain === 'object' &&
    chain !== null &&
 ...
 */
export function isSIWEMessage(message: any): message is SIWEMessage {
  return (
 ...
 */
export const VARITY_L3_TESTNET: VarityChainConstants = {
  CHAIN_ID: 33529,
 ...
 * ```
 */
export function formatUSDC(amount: bigint): USDCAmount {
