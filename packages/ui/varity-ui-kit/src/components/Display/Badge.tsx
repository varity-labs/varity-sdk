...
export function PriorityBadge({ priority }: { priority: string }) {
  if (!priority) return <Badge variant="gray">&mdash;</Badge>;
  return (
...
export function ProjectStatusBadge({ status }: { status: string }) {
  if (!status) return <Badge variant="gray">&mdash;</Badge>;
  return (
...
export function TaskStatusBadge({ status }: { status: string }) {
  if (!status) return <Badge variant="gray" dot>Unknown</Badge>;
  return (
...
export function RoleBadge({ role }: { role: string }) {
  if (!role) return <Badge variant="gray">&mdash;</Badge>;
  return (
