...
<head>
  ...
  <meta name="twitter:site" content="@VarityHQ">
...
<body>
  <div class="page">
    ...
    <div class="footer">
      <p>Built and deployed with <a href="https://www.varity.so">Varity</a> &mdash; 70% cheaper than AWS</p>
      <p><a href="https://www.varity.so">Build your own app</a></p>
    </div>
  </div>
</body>
</html>`;
