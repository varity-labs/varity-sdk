...
The workflow builds and pushes `ghcr.io/varity-labs/varity-gateway:<version>` automatically.
...
npm run build
docker build -t ghcr.io/varity-labs/varity-gateway:<version> .
docker push ghcr.io/varity-labs/varity-gateway:<version>
```
