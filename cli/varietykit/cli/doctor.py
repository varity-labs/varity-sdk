...
def doctor(ctx, fix, full):
    ...
    \b
    Examples:
      varietykit doctor         # Quick environment check
      varietykit doctor --full  # Full check with infrastructure
    """
    console = Console()
    ...
    if all_passed:
        ...
        console.print(
            Panel.fit(
                ...
                "Your environment is ready. Run [bold]varietykit app deploy[/bold] to deploy your app.",
                border_style="green",
            )
        )
        ...
        console.print(
            Panel.fit(
                ...
                "Please fix the issues above and run [bold]varietykit doctor[/bold] again.",
                border_style="red",
            )
        )
